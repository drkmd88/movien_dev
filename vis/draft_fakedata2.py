...
from bokeh.models import CustomJS,ColumnDataSource, HoverTool, Div,Legend
...
def main():
    ...
    # metadata = MetaData(db)      # movies = Table('movies', metadata, autoload=True)
